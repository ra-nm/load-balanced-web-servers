...
### This script is the script Microsoft provides to deploy ARM Templates
### with Azure CLI but modified to accept parameters for the template 
### and parameters file paths 
...
if [[ -z "$templateFilePath" ]]; then
	echo "Enter the path of your template file:"
	read templateFilePath
fi

if [[ -z "$parametersFilePath" ]]; then
	echo "Enter the path of your parameters file:"
